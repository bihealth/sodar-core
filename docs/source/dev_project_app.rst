...
use of `Class-Based Views <https://docs.djangoproject.com/en/5.2/topics/class-based-views/>`_
being a requirement.
...
.. note::
    ...
    `instructions in Django documentation <https://docs.djangoproject.com/en/5.2/howto/writing-migrations/#migrations-that-add-unique-fields>`_
