...
We first show you how to :ref:`integrate SODAR Core
<dev_projectroles_integration>` into an existing site. If you have set
up a new site using the SODAR Django template repository as described in
:ref:`getting_started`, you can skip the next chapter.
Next, we describe the process of developing
